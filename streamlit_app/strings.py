...
UI = {
    ...
    "page_content": "תוכן",
    "page_status": "סטטוס",
    "page_history": "היסטוריה וגרסאות",
    "view_version": "צפייה",
    "viewing_version": "צופה בגרסה",
    "read_only": "לקריאה בלבד",
    "back_to_live": "חזרה לדף הנוכחי",
    "version_latest": "העדכנית ביותר",
    "version_pin_to": "קיבוע לגרסה",
    ...
    "title_field": "כותרת",
    "title_immutable_hint": "לא ניתן לשנות כותרת לאחר יצירת הדף — ליצירת דף עם כותרת חדשה, יש ליצור דף נפרד",
    ...
    "ingestion_context_field": "הנחיה לחילוץ (אופציונלי)",
    "ingestion_context_placeholder": "לדוגמה: התמקד בסעיפי אבטחת מידע בלבד, התעלם מנספחים",
    "produce_no_candidates": "לא נמצאו נושאים במסמך",
    "produce_review_title": "מועמדים לאישור",
    "approve_all_button": "אשר הכל",
    "reject_all_button": "דחה הכל",
    "candidate_create_header": "דף חדש",
    "candidate_merge_header": "עדכון דף קיים",
    "candidate_link_header": "התאמה לדף קיים",
    "add_reference_confirm": 'להוסיף את הקובץ כמקור לדף "{title}"?',
    "original_content_label": "תוכן קיים",
    "proposed_content_label": "הצעת תוכן",
    "start_new_ingestion": "העלאה חדשה",
    "candidate_edit_button": "ערוך",
    "candidate_done_editing_button": "סיים עריכה",
